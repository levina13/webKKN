...
@section('layout_title', 'Tambah Galeri')
                  ...
                  <div class="mb-3 mb-sm-0">
                      <div class="row">
                          <div class="col-12 col-lg-6 d-flex">
                              <div class="fs-5 fw-normal justify-content-center align-self-center"><i class="fa-solid fa-image"></i> Tambah Galeri</div>
                          </div>
              ...
              <div class="row">
                  <div class="col-12 mb-3">
                      <div>
                          ...
                          <input class="form-control @error('judul') is-invalid @enderror" id="nama" name="judul" type="text" placeholder="Judul Galeri" value="{{ old('judul') }}" required>
                          @error('judul')

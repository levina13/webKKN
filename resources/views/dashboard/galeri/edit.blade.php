...
@section('layout_title', 'Edit Galeri')
...
<div class="py-4">
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ $galeri->judul }}</li>
        </ol>
    </nav>
</div>
                  ...
                  <div class="mb-3 mb-sm-0">
                      <div class="row">
                          <div class="col-12 col-lg-6 d-flex">
                              <div class="fs-5 fw-normal justify-content-center align-self-center"><i class="fa-solid fa-image"></i> {{ $galeri->judul }}</div>
                          </div>
              ...
              <div class="row">
                  <div class="col-12 mb-3">
                      <div>
                          ...
                          <input class="form-control @error('judul') is-invalid @enderror" id="nama" name="judul" type="text" placeholder="Judul Galeri" value="{{ old('judul', $galeri->judul) }}" required>
                          @error('judul')
              ...
              <div class="col-12">
                  <div class="card card-body border-0 shadow mb-4">
                      ...
                      <div class="d-flex align-items-center">
                          <div class="me-3">
                            <img class="rounded avatar-xl gambar-preview" src="/{{ old('foto', $galeri->foto) }}" alt="change" id="gambar-preview" />
                          </div>

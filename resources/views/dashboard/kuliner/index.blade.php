...
<div class="py-4">
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Daftar Kuliner</li>
        </ol>
    </nav>
</div>
<div class="row">
                ...
                <div class="mb-3 mb-sm-0">
                    <div class="row">
                        <div class="col-12 col-lg-6 d-flex">
                            <div class="fs-5 fw-normal justify-content-center align-self-center"><i class="fa-solid fa-utensils"></i> Daftar Kuliner</div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <a href="{{ route('kuliner.create') }}" class="btn btn-primary d-inline-flex align-items-center me-2 float-lg-end">
              ...
              columns: [
                  ...
                  },
                  {
                    ...
                    "render": function ( data, type, row, meta ) { 
                        return '<a href="/admin-page/kuliner/'+ data[0] +'/edit" class="btn btn-sm btn-warning btn-edit me-2" data-id="'+ data[0] +'" data-nama="'+ data[1] +'"><i class="fas fa-pencil me-2"></i>Edit</a> <button class="btn btn-sm btn-danger btn-delete" data-id="'+ data[0] +'" data-nama="'+ data[1] +'"><i class="fas fa-trash me-2"></i>Hapus</button>'
                    },
                  },
              ],
              columnDefs: [

              ...
              <div class="row">
                  <div class="col-12 mb-3">
                      <div>
                          ...
                          <input class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" type="text" placeholder="Nama Objek Wisata" value="{{ old('nama', $kuliner->nama) }}" required>
                          @error('nama')
